...
/**
 @file NQueensChecker.h
 @brief the "various specific functions for NQueens
 */
 ...
 */
void CalculateNumberOfVulnerableQueensForWorkingCandidate(void);
...
@brief NQueensfunction to add a new queen on board in the working candidate
 @param col intger value between 0 and N-1 - column to put next queen in
